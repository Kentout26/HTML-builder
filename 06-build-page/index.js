...
copyDir('06-build-page/assets/fonts', '06-build-page/project-dist/assets/fonts');
    ...
    fs.readFile(mainFile_path, 'utf8', (err, data) => {
        ...
        fs.writeFile(file_path, data, err => {
            ...
            fs.readFile(file_path, 'utf8', (err, data1) => {
                fs.readFile('06-build-page/components/header.html', 'utf8', (err, data2) => {
                    if(err) throw err;
                    fs.readFile('06-build-page/components/articles.html', 'utf8', (err, data3) => {
                        if(err) throw err;
                        fs.readFile('06-build-page/components/footer.html', 'utf8', (err, data4) => {
                            if(err) throw err;
